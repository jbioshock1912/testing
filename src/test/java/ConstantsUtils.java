...
public class ConstantsUtils {
    ...
    public static final String DEMOGA_UPLOAD_DOWNLOAD_URL = "https://demoqa.com/upload-download";
    ...
    public static final String DEMOGA_UPLOAD_FILE_XPATH = "//input[@id = 'uploadFile']";
